...
<body background="fondo1.jpg" height="1100px">
<div   id= "global">
<div id ="head">
...
<div id= "video">
<div  class="cuadro" id="cua1"><br><h1 align="center">Nuestro caf&eacute; </h1> <p id="p_vi"> Las condiciones clim&aacute;ticas del distrito de Villa Rica, la calidad de su tierra y las t&eacute;cnicas de producci&oacute;n de sus caficultores permiten obtener un grano que no podr&iacute;a conseguirse en otra parte del mundo. Estas particularidades han llevado a que este caf&Eacute; haya sido reconocido como el m&aacute;s fino en concursos internacionales.<br><br>
Tras la cosecha, los granos son llevados a la planta donde se realiza el despulpado (un proceso mediante el cual se retira la c&aacute;scara del caf&eacute;, la fermentaci&oacute;n de los granos, as&iacute; como el lavado, clasificaci&oacute;n y secado de los mismos.</p></div>
<div class="cuadro" id="cua2"><video src="video.mp4" height="350px" width="400x" controls="controls"></video></div>
 </div>
